...
from .views import index,welcome,about_us,introduction,updates,copyright,visualization_platform,openre_toolkit
urlpatterns = [
    path('', index),
    ...
    path('openre_toolkit/',openre_toolkit),
