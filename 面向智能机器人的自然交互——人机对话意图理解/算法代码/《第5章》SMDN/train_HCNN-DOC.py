...
for number in range(10):
    ...
    model = HCNN(MAX_SEQ_LEN, MAX_FEATURES, EMBEDDING_DIM, n_class_seen, logger, 'model.png', embedding_matrix, one_verse_all=True)
    ...
    model.save('data/HCNN-DOC_w3_' + str(proportion) + '_' +  str(number) + '.h5')
